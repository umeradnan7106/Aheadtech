...
const DEFAULT_SERVICES: Service[] = [
  { icon: 'icons8-post-ads-100.png', iconBg: '#EEF2F9', title: 'We run your ads (Meta + Google)', description: 'Find the right people, show them the right message, send them to a page that converts. Test, kill losers, scale winners.', resultValue: '3.2x', resultLabel: 'Avg return' },
  { icon: 'icons8-google-web-search-100.png', iconBg: '#EDFBF3', title: 'We get you found on Google (SEO)', description: 'When people search for what you sell, you show up. Free traffic that compounds every month.', resultValue: '2.4x', resultLabel: 'More traffic' },
  { icon: 'icons8-electricity-96.png', iconBg: '#F3E8FF', title: 'We fix your website (CRO)', description: "Most visitors leave without buying. We fix that. Same traffic, more sales. That's free money.", resultValue: '47%', resultLabel: 'More sales' },
  { icon: 'icons8-email-96.png', iconBg: '#FFFAEB', title: 'We email your customers', description: 'Welcome emails. Cart reminders. Win-back campaigns. Makes money while you sleep.', resultValue: '22%', resultLabel: 'Revenue lift' },
  { icon: 'icons8-website-80.png', iconBg: '#FEF3F2', title: 'We build your website', description: 'Shopify. WordPress. Custom. Fast, clean, built to sell — not just look pretty.', resultValue: '<2s', resultLabel: 'Load time' },
  { icon: 'icons8-social-media-marketing-96.png', iconBg: '#EEF2F9', title: 'We handle your social media', description: 'Content that builds trust so your ads work even better. Plan it, make it, post it.', resultValue: '3x', resultLabel: 'Engagement' },
]
